...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "SpaceInvadersProject", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "SpaceInvadersProject";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "SpaceInvadersProject", null, { width: 640, height: 480 });
...
class ApplicationMain {
	...
	public static function main () {
		...
		config = {
			...
			build: "18",
			company: "HaxeFlixel",
			file: "SpaceInvadersProject",
			fps: 60,
			name: "SpaceInvadersProject",
