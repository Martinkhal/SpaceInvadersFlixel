...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/images/cuadro1.png", "assets/images/cuadro1.png");
		type.set ("assets/images/cuadro1.png", AssetType.IMAGE);
		path.set ("assets/images/cuadro2.png", "assets/images/cuadro2.png");
		...
		path.set ("assets/images/navejugador.png", "assets/images/navejugador.png");
